...
Those type informations are required to deserialize data again. For serialized data that does not contain those type information it is possible to export all type information as a String and import them to another serializer instance.
